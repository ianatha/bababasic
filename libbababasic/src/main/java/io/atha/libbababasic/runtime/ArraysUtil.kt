...
import io.atha.libbababasic.domain.AbstractSTEntry
...
import io.atha.libbababasic.domain.STFloat32ArrayValue
import io.atha.libbababasic.domain.STFloat64ArrayValue
import io.atha.libbababasic.domain.STInt32ArrayValue
import io.atha.libbababasic.domain.STInt64ArrayValue
import io.atha.libbababasic.domain.STStringArrayValue
...
internal class ArraysUtil {
    ...
    companion object {
        ...
        fun allocArray(
            ...
            val arrayType = arrayEntry!!.type as ArrayType?
        ...
        @JvmStatic
        fun arrayref(symbolTable: SymbolTable, instruction: IR.Instruction) {
        ...
        @JvmStatic
        fun arrayfill(symbolTable: SymbolTable, instruction: IR.Instruction) {
        ...
        @JvmStatic
        fun arrayCopy(symbolTable: SymbolTable, instruction: IR.Instruction) {
