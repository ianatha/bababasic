...
import io.atha.libbababasic.runtime.Formatter
...
interface PuffinBasicType {
    ...
    fun newInstance(symbolTable: SymbolTable): STValue
...
interface STValue {
    ...
    fun checkInitialized() {
        if (!this.isInitialized) {
            throw RuntimeError(
                RuntimeError.ErrorCode.NOT_INITIALIZED,
...
class ScalarType(override val atomTypeId: PuffinBasicAtomTypeId) : PuffinBasicType {
    ...
    override fun newInstance(symbolTable: SymbolTable): STValue {
...
internal class MemberFunctions internal constructor(memberFunctions: List<MemberFunction>) {
    ...
    fun checkFuncCallArguments(funcName: String, paramTypes: List<PuffinBasicType>) {
        ...
        if (expectedParamTypes.size != paramTypes.size) {
            throw RuntimeError(
                RuntimeError.ErrorCode.BAD_FUNCTION_CALL,
            ...
            listOf(
                ...
                MemberFunction(
                    ...
                    if (index < 0 || index >= list.size) {
                        throw RuntimeError(
                            RuntimeError.ErrorCode.ARRAY_INDEX_OUT_OF_BOUNDS,
                            "List index: " + index
...
abstract class AbstractSTEntry internal constructor(
    ...
    fun createAndSetInstance(symbolTable: SymbolTable) {
...
class STRef internal constructor(type: PuffinBasicType?) : STLValue(null, type) {
    var ref: STEntry? = null
        get() {
            if (field == null) {
                throw InternalError("Ref is null")
            }
            return field
        }
        set(ref) {
...
internal class STLabel : AbstractSTEntry(STInt32ScalarValue(), null) {
    override val type: PuffinBasicType?
        get() {
            throw InternalError("Labels don't have a type!")
        }
}
...
private class STInt32ScalarValue : STValue {
    ...
    override var string: String?
        ...
        set(value) {
            throw InternalError("Can't cast String to int32: '$value'")
        }
}
...
private class STInt64ScalarValue : STValue {
    ...
    override var string: String?
        ...
        set(value) {
            throw InternalError("Can't cast String to int64: '$value'")
        }
}
...
private class STFloat32ScalarValue : STValue {
    ...
    override var string: String?
        ...
        set(value) {
            throw InternalError("Can't cast String to float32: '$value'")
        }
}
...
private class STFloat64ScalarValue : STValue {
    ...
    override var string: String?
        ...
        set(value) {
            throw InternalError("Can't cast String to float64: '$value'")
        }
}
