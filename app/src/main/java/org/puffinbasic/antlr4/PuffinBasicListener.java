...
public interface PuffinBasicListener extends ParseTreeListener {
    ...
    /**
     * Enter a parse tree produced by the {@code FuncLTrimDlr}
     * labeled alternative in {@link PuffinBasicParser#func}.
     *
     * @param ctx the parse tree
     */
    void enterFuncLTrimDlr(PuffinBasicParser.FuncLTrimDlrContext ctx);

    /**
     * Exit a parse tree produced by the {@code FuncLTrimDlr}
     * labeled alternative in {@link PuffinBasicParser#func}.
     *
     * @param ctx the parse tree
     */
    void exitFuncLTrimDlr(PuffinBasicParser.FuncLTrimDlrContext ctx);

    /**
     * Enter a parse tree produced by the {@code FuncRTrimDlr}
     * labeled alternative in {@link PuffinBasicParser#func}.
     *
     * @param ctx the parse tree
     */
    void enterFuncRTrimDlr(PuffinBasicParser.FuncRTrimDlrContext ctx);

    /**
     * Exit a parse tree produced by the {@code FuncRTrimDlr}
     * labeled alternative in {@link PuffinBasicParser#func}.
     *
     * @param ctx the parse tree
     */
    void exitFuncRTrimDlr(PuffinBasicParser.FuncRTrimDlrContext ctx);
